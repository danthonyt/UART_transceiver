class axil_ar_txn extends uvm_sequence_item;
  `uvm_object_utils(axil_ar_txn)

  rand u32 addr;     // address of transaction

  function void do_copy(uvm_object rhs);
    axil_ar_txn copied_transaction_h;
  ...
  function bit do_compare(uvm_object rhs, uvm_comparer comparer);
    axil_ar_txn compared_transaction_h;
    bit   same;
